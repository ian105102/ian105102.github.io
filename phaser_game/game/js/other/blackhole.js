let blackhole = function (game, player) {
   ...
   this.blackOverlay.fillRect(0, 0, this.game.cameras.main.width, this.game.cameras.main.height);
...
blackhole.prototype.Update = function () {
  ...
  if (distance < 300) {
    this.blackOverlay.alpha+= (1/(distance*distance/4000) -this.blackOverlay.alpha)/10;
